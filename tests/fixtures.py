    ...
    return {
        ...
        'repository': {
            ...
            'owner': {
                ...
                'organizations_url': 'https://api.github.com/users/%(user)s/'
                                     'orgs' % c,
                'repos_url': 'https://api.github.com/users/%(user)s/'
                             'repos' % c,
                'events_url': 'https://api.github.com/users/%(user)s/'
                              'events{/privacy}' % c,
                'received_events_url': 'https://api.github.com/users/'
            ...
            'keys_url': 'https://api.github.com/repos/%(url)s/'
                        'keys{/key_id}' % c,
            ...
            'blobs_url': 'https://api.github.com/repos/%(url)s/git/'
                         'blobs{/sha}' % c,
            'git_tags_url': 'https://api.github.com/repos/%(url)s/git/'
                            'tags{/sha}' % c,
            'git_refs_url': 'https://api.github.com/repos/%(url)s/git/'
                            'refs{/sha}' % c,
            'trees_url': 'https://api.github.com/repos/%(url)s/git/'
                         'trees{/sha}' % c,
            'statuses_url': 'https://api.github.com/repos/%(url)s/'
                            'statuses/{sha}' % c,
            'languages_url': 'https://api.github.com/repos/%(url)s/'
                             'languages' % c,
            'stargazers_url': 'https://api.github.com/repos/%(url)s/'
                              'stargazers' % c,
            ...
            'subscription_url': 'https://api.github.com/repos/%(url)s/'
                                'subscription' % c,
            'commits_url': 'https://api.github.com/repos/%(url)s/'
                           'commits{/sha}' % c,
            ...
            'downloads_url': 'https://api.github.com/repos/%(url)s/'
                             'downloads' % c,
            'issues_url': 'https://api.github.com/repos/%(url)s/'
                          'issues{/number}' % c,
            'pulls_url': 'https://api.github.com/repos/%(url)s/'
                         'pulls{/number}' % c,
            ...
            'labels_url': 'https://api.github.com/repos/%(url)s/'
                          'labels{/name}' % c,
            'releases_url': 'https://api.github.com/repos/%(url)s/'
                            'releases{/id}' % c,
...
def ORG(login):
    ...
    return {
        ...
        'members_url': 'https://api.github.com/orgs/%s/'
